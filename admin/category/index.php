...
<?php
    ...
    if(isset($_GET['nama'])) {
        $sql .= " WHERE nama_kategori LIKE CONCAT('%', ?, '%')";
    }
            ...
            <form action="/admin/category">
                <div class="flex flex-row justify-between">
                    <div class="flex">
                        ...
                        <h1 class="flex-none ml-3 my-auto">Kategori</h1>
                    </div>
                    <div class="flex">
                        ...
                        <button class="ml-3 bg-green-600 px-3 py-2 rounded-md hover:bg-green-800 hover:shadow-md text-white transition text-sm"><a href="/admin/category/add">Buat Kategori Baru</a></button>
                    </div>
                </div>
            </form>
